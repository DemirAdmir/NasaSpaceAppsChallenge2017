    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a  href="./logout.php?logout"><span>Log out</span></a></li>
    ...
    <div class="thumbnail">
      ...
      <div class="caption">
	   <h3 style="font-size:15px;" ><img src="icons/dangerous.png" alt="..."  > Hazardous Areas</h3>
        <p><button id="drop" onclick="createMarker('hazard')" class="btn btn-primary" role="button">Add Marker</button> </p>
      </div>
    </div>
		</center>
  </div>
